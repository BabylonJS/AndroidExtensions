...
namespace java::websocket
{
    ...
    private:
        ...
        static java::websocket::WebSocketClient* FindClientInstance(JNIEnv* env, jobject obj);
        static std::vector<std::pair<jobject, java::websocket::WebSocketClient*>> s_objectVector;
